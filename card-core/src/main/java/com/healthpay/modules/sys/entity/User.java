...
import com.healthpay.common.utils.Collections3;
import com.healthpay.common.utils.excel.annotation.ExcelField;
import com.healthpay.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private Date loginDisabledTime; // 禁止登录时刻
	private Integer loginFailNum;//连续登陆失败次数
	private String photo; // 头像
	private String qrCode; // 二维码
	private String oldLoginName;// 原登录名
	private String newPassword; // 新密码
	private Date passwordExpiredTime;//密码过期时刻
	...
	@ExcelField(title = "所属区域", align = 2, sort = 120)
	public Area getArea() {
		return area;
	}
	...
	public Date getLoginDisabledTime() {
		return loginDisabledTime;
	}

	public void setLoginDisabledTime(Date loginDisabledTime) {
		this.loginDisabledTime = loginDisabledTime;
	}
