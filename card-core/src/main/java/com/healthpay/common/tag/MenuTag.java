package com.healthpay.common.tag;
...
public class MenuTag extends TagSupport {
    ...
    private static String getChildOfTree(Menu parent, int level, List<Menu> menuList) {
        ...
        if (null == parent || !parent.hasPermisson()) {
            return "";
        }
        ...
        if (((parent.getHref() == null) || parent.getHref().trim().equals("")) && parent.getIsShow().equals("1")) {    // 如果是父节点且显示
            if (level > 0) {
                menuString.append("<a href=\"" + href + "\"><i class=\"fa " + parent.getIcon()
            ...
            menuString.append("<a class=\"J_menuItem\"  href=\"" + href + "\" ><i class=\"fa " + parent.getIcon()
