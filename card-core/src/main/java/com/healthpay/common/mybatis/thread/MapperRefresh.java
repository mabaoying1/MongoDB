package com.healthpay.common.mybatis.thread;

import com.google.common.collect.Sets;
import com.healthpay.common.utils.PropertiesLoader;
...
public class MapperRefresh implements java.lang.Runnable {
    ...
    static {
        ...
        enabled = "true".equalsIgnoreCase(propertiesLoader.getProperty("enabled"));

        delaySeconds = propertiesLoader.getInteger("delaySeconds");
        sleepSeconds = propertiesLoader.getInteger("sleepSeconds");
        mappingPath = propertiesLoader.getProperty("mappingPath");
                ...
                public void run() {
                    ...
                    if (location == null){
                        ...
                        for (Resource mapperLocation : mapperLocations) {
                            ...
                            s = s.substring("URL [".length(), s.lastIndexOf(mappingPath) + mappingPath.length());
                    ...
                    log.debug("========= Enabled refresh mybatis mapper =========");
