...
<body class="gray-bg">
	...
	<form:form id="searchForm" modelAttribute="hpIfaceMerchant" action="${ctx}/interface/hpIfaceMerchant/" method="post" class="form-inline">
		...
		<div class="form-group">
			...
			<span>机构编码：</span>
				<form:input path="orgCode" htmlEscape="false" maxlength="50"  class=" form-control input-sm"/>
		 </div>	
	</form:form>
	<br/>
	</div>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column mer_name">机构名称</th>
				<th  class="sort-column mer_ename">英文名称</th>
				<th  class="sort-column org_code">机构编码</th>
				<th>操作</th>
			</tr>
		</thead>
		<tbody>
