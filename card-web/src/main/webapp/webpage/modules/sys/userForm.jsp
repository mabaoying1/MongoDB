		   ...
		   <tbody>
		      <tr>
				  ...
				  <td class="width-35"><input id="oldLoginName" name="oldLoginName" type="hidden" value="${user.loginName}">
					  <form:input path="loginName" htmlEscape="false" maxlength="10" class="form-control required userName"/></td>
		      </tr>
		      ...
		      <tr>
		         ...
		         <td><input id="newPassword" name="newPassword" type="password" value="" maxlength="20" minlength="8" class="form-control ${empty user.id?'required':''}"/>
		         ...
		         <td><input id="confirmNewPassword" name="confirmNewPassword" type="password"  class="form-control ${empty user.id?'required':''}" value="" maxlength="20" minlength="8" equalTo="#newPassword"/></td>
		      </tr>
		      
		       <tr>
		         <td class="active"><label class="pull-right">邮箱:</label></td>
		         <td><form:input path="email" htmlEscape="false" maxlength="20" class="form-control email"/></td>
		         <td class="active"><label class="pull-right">电话:</label></td>
		         <td><form:input path="phone" htmlEscape="false" maxlength="20" class="form-control"/></td>
		      </tr>
		      
		      <tr>
		         <td class="active"><label class="pull-right">手机:</label></td>
		         <td><form:input id="mobile" path="mobile" htmlEscape="false" maxlength="13" class="form-control"/></td>
				  <td class="active"><label class="pull-right">工号:</label></td>
				  <td><form:input path="no" htmlEscape="false" maxlength="10" class="form-control"/></td>
		      </tr>
		      
		      <tr>
		         <td class="active"><label class="pull-right">用户角色:</label></td>
		         <td>
		         	<form:checkboxes path="roleIdList" items="${allRoles}" itemLabel="name" itemValue="id" htmlEscape="false" cssClass="i-checks"/>
		         	<label id="roleIdList-error" class="error" for="roleIdList"></label>
		         </td>
				  <td class="active"><label class="pull-right">备注:</label></td>
				  <td><form:textarea path="remarks" htmlEscape="false" rows="3" maxlength="20" class="form-control"/></td>
		      </tr>
