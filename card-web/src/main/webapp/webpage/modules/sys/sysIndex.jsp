...
<head>
    ...
    <title>居民健康通管理平台</title>
	<%@ include file="/webpage/include/head.jsp"%>
	<script src="${ctxStatic}/toastr/toastr.min.js" type="text/javascript"></script>
	<link href="${ctxStatic}/toastr/toastr.min.css" rel="stylesheet"/>
    <script src="${ctxStatic}/common/inspinia.js?v=3.2.0"></script>
    <script src="${ctxStatic}/common/contabs.js"></script>
    <meta name="keywords" content="居民健康通管理平台">
    <meta name="description" content="居民健康通管理平台">
    <style>
        #content-main {
            height: 100%;
        }
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header" style="padding-left: 0px;">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span class="text-muted text-xs block" style="color: red">${fns:getUser().company.name}<b class="caret"></b></span>
                                </span>
                            </a>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-left"><a href="#">居民健康通管理平台</a> &copy; 2015-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->
