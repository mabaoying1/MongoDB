...
<head>
    ...
    <link rel="stylesheet" href="${ctxStatic}/ace/assets/jquery-ui.css" >
    <link rel="stylesheet" href="${ctxStatic}/ace/assets/css/jquery-ui.custom.css" >
    <style type="text/css">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form:form id="searchForm" modelAttribute="hpCardholder"
                               action="${ctx}/analysis/table/" method="post"
                               class="form-inline">
                        ...
                        <div class="form-group">
                            <span>日期：</span>
                            <form:select path="flag09"  class="form-control m-b">
                                <form:options items="${fns:getDictList('create_date')}"  itemLabel="label" itemValue="value" htmlEscape="false"/>
                            </form:select>
                            <span>区域：</span>
            ...
            <table id="contentTable"
                ...
                <c:forEach items="${page.list}" var="hpCardholder">
                    <tr>
                        ...
                        <td>${hpCardholder.provname2}${hpCardholder.cityname2}${hpCardholder.countyname2}</td>
