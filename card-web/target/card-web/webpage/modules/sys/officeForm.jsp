		   ...
		   <tbody>
		      <tr>
		         ...
		         <td class="width-35"><sys:treeselect id="area" name="area.id" value="${office.area.id}" labelName="area.name" labelValue="${office.area.name}"
					title="区域" url="/sys/area/treeData?type=3" cssClass="form-control required" officeId="officeId"/></td>
		      </tr>
		       <tr>
		         ...
		         <td  class="width-15"  class="active"><label class="pull-right"><font color="red">*</font>机构编码:</label></td>
		      ...
		      <tr>
		         ...
		         <td class="width-35"><sys:treeselect id="primaryPerson" name="primaryPerson.id" value="${office.primaryPerson.id}" labelName="office.primaryPerson.name" labelValue="${office.primaryPerson.name}"
					title="用户" url="/sys/user/treeData" cssClass="form-control" allowClear="true" notAllowSelectParent="true"/></td>
		      </tr>
		      <tr>
			  ...
			  <tr>
				  ...
				  <td class="width-35"><form:input path="merId" htmlEscape="false" maxlength="50" cssClass="form-control required" /></td>
			  </tr>
	      </tbody>
	      </table>
	</form:form>
