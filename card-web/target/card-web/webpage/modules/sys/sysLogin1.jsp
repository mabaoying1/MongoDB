						...
						<div class="login-container">
							...
							<div class="center">
								<h1>
									<br/>
									<%--
									<img src="${ctxStatic }/common/login/images/logo2.png" style="width:280px">
									 --%>
									<br>
								</h1>
												...
												<fieldset>
													...
													<div id="themeSwitch" class="dropdown">
														...
														<ul class="dropdown-menu">
														  <c:forEach items="${fns:getDictList('theme')}" var="dict"><li><a href="#" onclick="location='${pageContext.request.contextPath}/theme/${dict.value}?url='+location.href"><font color="blue">${dict.label}</font></a></li></c:forEach>
														</ul>
							...
							<div class="center"><h4 id="id-company-text"><font color="#A90E0E">居民健康通管理系统</font></h4></div>
						</div>
					</div><!-- /.col -->
				</div><!-- /.row -->
			</div><!-- /.main-content -->
