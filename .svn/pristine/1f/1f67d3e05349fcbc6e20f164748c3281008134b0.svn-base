...
import com.healthpay.common.beanvalidator.BeanValidators;
...
import com.healthpay.modules.sys.entity.SystemConfig;
import com.healthpay.modules.sys.entity.User;
import com.healthpay.modules.sys.service.SystemConfigService;
import com.healthpay.modules.sys.service.SystemService;
import com.healthpay.modules.sys.utils.UserUtils;
import com.healthpay.modules.tools.utils.TwoDimensionCode;
...
//				try {
//					office.setName(URLDecoder.decode(office.getName(), "utf-8"));
...
//		}
	...
	public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		...
		user.setArea(new Area(office.getArea().getId()));
		// 如果新密码为空，则不更换密码
		if (StringUtils.isNotBlank(user.getNewPassword())) {
			...
			user.setPasswordExpiredTime(calendar.getTime());
		}
...
//				currentUser.setPhoto(user.getPhoto());
	...
	@RequiresPermissions("user")
	@RequestMapping(value = "getModifyExpiredPwd")
	public String getModifyExpiredPwd(){
		return "modules/sys/passwordExpired";
	}
	...
	@ResponseBody
	@RequiresPermissions("user")
	@RequestMapping(value = "modifyExpiredPwd",method=RequestMethod.GET)
	public String modifyExpiredPwd(@RequestParam(value="oldPassword")String oldPassword, @RequestParam(value="newPassword")String newPassword) {
	...
	public List<Map<String, Object>> treeData(@RequestParam(required=false) String officeId, HttpServletResponse response) {
		...
		for (int i=0; i<list.size(); i++){
			...
			map.put("pId", null == officeId?0:officeId);
