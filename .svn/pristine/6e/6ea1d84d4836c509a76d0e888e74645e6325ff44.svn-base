...
public class Des {
	...
	public static void main(String[] args) {
		...
		String key3 = "3";
		String data = "admin";
		String str = desObj.strEnc(data, "012C2C9BA925FAF8045B2FD9B02A2664", null, null);
		System.out.println("加密===" + str);
		String dec = desObj.strDec("2c3a0555a578ed8e", "012C2C9BA925FAF8045B2FD9B02A2664", null, null);
