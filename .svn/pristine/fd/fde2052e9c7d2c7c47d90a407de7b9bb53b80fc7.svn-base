...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			//var zNodes2=[
                    <%--
					<c:forEach items="${areaList}" var="area">//{id:"${area.id}", pId:"${not empty area.parent?area.parent.id:0}", name:"${area.name}"},
		            </c:forEach>];
		            --%>
		   ...
		   <tbody>
		      ...
		      <tr>
		         ...
		         <td class="width-35"><input id="oldEnname" name="oldEnname" type="hidden" value="${role.enname}">
					<form:input path="enname" htmlEscape="false" maxlength="50" class="form-control"/></td>
		      ...
		      <tr>
		         ...
		         <td class="width-35" colspan="3"><form:select path="dataScope" class="form-control ">
