 ...
 * @version 2016-06-16
 */
public class HpIfaceMsgqueue extends DataEntity<HpIfaceMsgqueue> {
	...
	private Integer errcount;		// 发送错误次数
	...
	public HpIfaceMsgqueue() {
		super();
	}

	public HpIfaceMsgqueue(String id){
		super(id);
	}
	...
	@ExcelField(title="发送错误次数", align=2, sort=16)
