...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 * @param oldPattern 转换前的日期格式
	 * @param newPattern 转换后的日期格式
	 * @return
	 * @throws Exception
	 */
	public static String dateStringFormate(String dateString,String oldPattern,String newPattern) throws Exception {
...
//		System.out.println(DateUtils.formatDate(new Date(),"yyyyMMddHHmmss"));
		String date=dateStringFormate("2019-08-12","yyyy-MM-dd","yyyyMMdd");
		System.out.println(date);

		System.out.println("2019-08-14".replace("-",""));
		System.out.println(parseDate("20190815"));
	}
}
