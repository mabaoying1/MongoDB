...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	/**
	 * 计算健康卡号校验码 校验码的编码规则为： 9 - 取余数[（除校验码外各位数字之和）/10]
	...
	/*	String ss = stringAppendZero("4420", 6);
		System.out.println(ss);*/
		/*List<String> data=Collections.emptyList();
		System.out.println(data);
		String a=getStringRandom(64);
		System.out.println("a===="+a);*/
		String str1="p7q91UV784a0mlvz46N2c542n3V73yD5I4x6919X14630rKQYwj074Z15k47p449"+"A1019"+"1560187284801"+"<?xml version=\"1.0\"?><Data><Head><Merid>12345</Merid><Funcid>A1019</Funcid><RetCode/><Errmsg/><Timer>1560187284801</Timer></Head><Body><HealthCardId>5101211006377556</HealthCardId></Body></Data>";
		String str2=getMD5Code(str1);
