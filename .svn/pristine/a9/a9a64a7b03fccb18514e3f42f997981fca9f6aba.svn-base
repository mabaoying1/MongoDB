 ...
 */
package com.healthpay.common.config;
...
public class Global {
	 ...
	 * 接口文件基础虚拟路径
	 */
	public static final String IFACEFILES_BASE_URL = "/ifacefiles/";
...
//		System.out.println("userfiles.basedir: " + dir);
	...
	public static void modifyConfig(String key, String value) {
		try {
			...
			String path = Global.class.getResource("/jdbc.properties").getPath();
