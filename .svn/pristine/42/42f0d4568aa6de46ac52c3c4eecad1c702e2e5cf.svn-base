            ...
            <div class="row">
                <div class="col-sm-12">
                    <form:form id="searchForm" modelAttribute="hpCardholder"
                               action="${ctx}/analysis/resident/" method="post"
                               class="form-inline">
                ...
                <table id="contentTable"
                    ...
                    <c:forEach items="${page.list}" var="hpCardholder">
                        <tr>
                            ...
                            <td>${hpCardholder.countryname2}${hpCardholder.provname2}${hpCardholder.cityname2}${hpCardholder.countyname2}${hpCardholder.townname2}${hpCardholder.villagename2}</td>
