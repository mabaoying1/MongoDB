...
<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="edit()" title="审核"><i class="fa fa-file-text-o"></i> ${label==null?'审核':label}</button>
                        </button>
